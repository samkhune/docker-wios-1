...
CREATE TABLE `adm_featureaccess` (
  ...
  `UcConnect` tinyint(1) DEFAULT 1,
  `UcWifiScan` tinyint(1) DEFAULT 1,
  `UcConfigure` tinyint(1) DEFAULT 1,
  `UcPacketCapture` tinyint(1) DEFAULT 1,
  `UcRawResponseData` tinyint(1) DEFAULT 0,
  `RemoteTroubleshoot` tinyint(1) DEFAULT 1,
  PRIMARY KEY (`id`),
...
INSERT INTO `adm_featureaccess` VALUES (1,3,0,3,NULL,3,0,0,0,0,3,3,NULL,3,3,3,3,3,3,3,3,3,3,0,0,0,1,0,0,3,0,NULL,3,3,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,0,0,0,0,0,0);
...
CREATE TABLE `ap_profiles` (
  ...
  `EnableTrafficSDWAN` tinyint(1) DEFAULT 0,
  `OperatorId` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `byod` (
  ...
  `enableUniquePsk` tinyint(1) DEFAULT 0,
  `uniquePsk` varchar(50) DEFAULT NULL,
...
CREATE TABLE `connect_ap` (
  ...
  `status` varchar(15) DEFAULT NULL,
  `status_time` varchar(25) DEFAULT NULL,
...
CREATE TABLE `portal_config` (
  ...
  `EnableApproval` tinyint(4) DEFAULT NULL,
  `ApprovalSignature` varchar(300) DEFAULT NULL,
...
--
-- Table structure for table `uniquePSK`
--

DROP TABLE IF EXISTS `uniquePSK`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;

CREATE TABLE `uniquePSK` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `macaddress` varchar(100) NOT NULL,
  `psk` varchar(250) DEFAULT NULL,
  `vlan` varchar(50) DEFAULT NULL,
  `ActionType` enum('byod','psk') DEFAULT NULL,
  `addedOn` datetime NOT NULL DEFAULT current_timestamp(),
  `updateOn` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `customerid` int(11) NOT NULL,
  `operatorid` int(11) DEFAULT NULL,
  `pskProfilePolicyId` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Dumping data for table `uniquePSK`
--

LOCK TABLES `uniquePSK` WRITE;
/*!40000 ALTER TABLE `uniquePSK` DISABLE KEYS */;
/*!40000 ALTER TABLE `uniquePSK` ENABLE KEYS */;
UNLOCK TABLES;



--
-- Table structure for table `uniquepskPolicyProfile`
--

DROP TABLE IF EXISTS `uniquepskPolicyProfile`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;

CREATE TABLE `uniquepskPolicyProfile` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ProfileName` varchar(30) DEFAULT NULL,
  `description` text DEFAULT NULL,
  `addedOn` datetime NOT NULL DEFAULT current_timestamp(),
...
--
-- Dumping data for table `uniquepskPolicyProfile`
--

LOCK TABLES `uniquepskPolicyProfile` WRITE;
/*!40000 ALTER TABLE `uniquepskPolicyProfile` DISABLE KEYS */;
/*!40000 ALTER TABLE `uniquepskPolicyProfile` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `approves_details`
--

DROP TABLE IF EXISTS `approves_details`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `approves_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Fullname` varchar(100) DEFAULT NULL,
  `EmailId` varchar(100) DEFAULT NULL,
  `CellPhone` varchar(20) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `customerid` (`CustomerId`),
  CONSTRAINT `adm_customer_fk1` FOREIGN KEY (`CustomerId`) REFERENCES `adm_customer` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `approves_details` WRITE;
/*!40000 ALTER TABLE `approves_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `approves_details` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `approve_user_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `approve_user_logs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `UserId` int(11) NOT NULL,
  `ApprovedBy` int(11) NOT NULL,
  `Approved` tinyint(1) DEFAULT NULL,
  `IsUsed` tinyint(1) DEFAULT 0,
  `ApprovalSendTimeStamp` datetime DEFAULT NULL,
  `ApprovedDateTimeStamp` datetime DEFAULT NULL,
  `ApprovalURL` varchar(250) DEFAULT NULL,
  `isEmail` tinyint(1) DEFAULT 0,
  `isSms` tinyint(1) DEFAULT 0,
  `MobileNumber` varchar(15) DEFAULT NULL,
  `Email` varchar(50) DEFAULT NULL,
  ...
  CONSTRAINT `adm_customer_approve_fk1` FOREIGN KEY (`CustomerId`) REFERENCES `adm_customer` (`id`) ON DELETE CASCADE,
  CONSTRAINT `approves_details_fk2` FOREIGN KEY (`ApprovedBy`) REFERENCES `approves_details` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
LOCK TABLES `approve_user_logs` WRITE;
/*!40000 ALTER TABLE `approve_user_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `approve_user_logs` ENABLE KEYS */;
UNLOCK TABLES;
